...
@Component({
  ...
  styleUrl: './sale-service.component.css',
})
export class SaleServiceComponent {
  @Input() service: any;
  ...
  save() {
    this.item.sale_id = this.service.id;
    this.loading = true;
    this.errors = null;
    this.servicio.api('sale/addService', 'post', this.item).subscribe(
      (res: any) => {
